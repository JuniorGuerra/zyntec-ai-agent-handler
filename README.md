...
- [ ] `reschedule_appointment` - Mover cita a otra fecha/hora
- [ ] `list_appointments` - Mostrar citas futuras del cliente
- [ ] `add_to_waitlist` - Agregar a lista de espera
- [ ] `send_calendar_invite` - Enviar .ics al email del cliente
